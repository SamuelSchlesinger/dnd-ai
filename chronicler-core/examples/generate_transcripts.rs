...
//!
//! Run with: `cargo run -p chronicler-core --example generate_transcripts`
...
async fn run_scenario(
    ...
    // Footer
    transcript.push_str(
        "*This transcript was generated by [chronicler](https://github.com/SamuelSchlesinger/chronicler), \
        an AI Dungeon Master powered by a configurable LLM.*\n"
    );
