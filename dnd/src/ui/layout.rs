...
/// Calculate the main layout areas for exploration mode
...
impl AppLayout {
    /// Calculate layout based on terminal size (70/30 split for exploration)
    pub fn calculate(area: Rect) -> Self {
        ...
        // Content area: narrative + sidebar (70/30 split)
...
/// Combat-specific layout (65/35 split)
...
impl CombatLayout {
    ...
    pub fn calculate(area: Rect) -> Self {
        ...
        // Combat content: narrative + tracker (65/35 split)
        let content_chunks = Layout::default()
            .direction(Direction::Horizontal)
            .constraints([
